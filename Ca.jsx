...
function Card({ setSelectedCountry, cardType, setCardType }) {
    ...
    useEffect(() => {
        if (selectedCountries.length > 0) {
            ...
            // Logic for setting countryUrl, maBodyName, and maBodyUrl can be similar to the original code
            ...
            // Resetting the state if no country is selected
            // setCountryUrl('');
            // setMaBodyName('');
            // setMaBodyUrl('');
        }
                    ...
                    <tbody>
                        {selectedCountries.map((country, index) => (
                            <tr key={index}>
                                <td>{country}</td>
                                <td>
                                    {/* Add corresponding URLs and other details based on the selected country */}
                                </td>
                            </tr>
                        ))}
                    </tbody>
